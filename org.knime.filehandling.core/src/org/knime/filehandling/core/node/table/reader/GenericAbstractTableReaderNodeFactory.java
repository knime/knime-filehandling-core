...
public abstract class GenericAbstractTableReaderNodeFactory<I, C extends ReaderSpecificConfig<C>, T, V>
    ...
    final class GenericConfigAndSourceSerializer implements ConfigAndSourceSerializer<I, SourceSettings<I>, C, T, StorableMultiTableReadConfig<C, T>> {

        @Override
        public void saveSettingsTo(final SourceSettings<I> sourceSettings, final StorableMultiTableReadConfig<C, T> config,
        ...
        @Override
        public void validateSettings(final SourceSettings<I> sourceSettings, final StorableMultiTableReadConfig<C, T> config,
        ...
        public void loadValidatedSettingsFrom(final SourceSettings<I> sourceSettings,
            final StorableMultiTableReadConfig<C, T> config, final NodeSettingsRO settings) throws InvalidSettingsException {
    ...
    @Override
    protected ConfigAndSourceSerializer<I, SourceSettings<I>, C, T, StorableMultiTableReadConfig<C, T>> createSerializer() {
